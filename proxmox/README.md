...
```bash
curl -fsSL https://raw.githubusercontent.com/K0uzia/tracebaie/proxmox/scripts/proxmox-setup.sh | sudo bash -s install
```

### Installation manuelle

```bash
git clone --branch proxmox https://github.com/K0uzia/tracebaie.git
cd workspace
